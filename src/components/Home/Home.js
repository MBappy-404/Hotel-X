          ...
          <div>
               <div className="hero min-h-screen bg-base-200">
                    <div className="hero-content flex-col lg:flex-row">
                         <img src="https://i.ytimg.com/vi/FJ0r2DWqKMA/maxresdefault.jpg" className="w-80 rounded-lg shadow-2xl" />
                         <div className='text-center'>
                              <h1 className="text-3xl  font-bold">Welcome To Hotel-X!</h1>
               ...
               >
                    <div className="container mx-auto">
                         ...
                         <div className="-mx-4 flex flex-wrap p-10 justify-center">
                              ...
                              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                                   <div
                                        className="border-primary text-purple shadow-pricing relative z-10 mb-10 overflow-hidden rounded-xl border border-opacity-20 bg-white py-10 px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12"
                                   >
